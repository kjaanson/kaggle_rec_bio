...
train_data_all = train_data_all.loc[
    train_data_all.sirna.isin(["sirna_706", "sirna_1046", "sirna_586", "sirna_747"]), :
]
...
# %%
model.compile(
    loss="sparse_categorical_crossentropy", optimizer=Adam(0.0001), metrics=["accuracy"]
)
